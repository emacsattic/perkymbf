...
;; X-CVS:    $Id: perkymbf.el,v 1.26 2002/10/16 00:29:49 nwv Exp $ GMT
...
;; [Version 0.2, 15-Oct-2002] Updated email address.  Minor comment changes,
;; including noting Emacs 21 compatibility.
;;
;; [Version 0.1, 05-Dec-2000] Initial release.

;;; Code:

(defconst perkymbf-version "0.2")
...
(defmacro perkymbf-defadvice-echoprompter (symbol)
  ...
  (let ((advice-sym        (intern (format "perkymbf-%s-advice-echoprompter"
                                           symbol)))
